/**
 * @classdesc This class contains the expected attributes
 * and methods for recording habits.
 */
var Setup = class Setup {
  /**
   ...
   * example of usage
   * ```js
   * setup.dayExists('31/12') // true or false
   * ```
   *
   * @param {string} date `DD/MM`
   * - `DD` day with 2 digits (01-31)
...
function save() {
  localStorage.setItem("Setup@habits", JSON.stringify(setup.data))
}
